...
public class BookMyShow {
    ...
    public static void main(String[] args) {
        ...
        // Creating Registered User --> Mahesh
        RegisteredUser mahesh = new RegisteredUser("Mahesh");
        ...
        */
        // Now suppose MAHESH and SAURABH both wants to book 10 tickets each for first show
        // Then Book My show will create two Ticket Booking threads for their requests

        Show bookingShow = searchedShow.get(0);

        // Ticket Booking Thread for the request made by MAHESH for 10 Seats
        TicketBookingThread t1 = new TicketBookingThread(bookingShow,mahesh,10);
        ...
        // After execution t1 will carry MAHESH ticket and t2 will carry SAURABH ticket
        Ticket mahesh_ticket = t1.getTicket();
        ...
        // Suppose MAHESH wants another 15 seats and SAURABH wants another 10 seats to be booked

        // Ticket Booking Thread for the request made by MAHESH for another 15 Seats
        TicketBookingThread t3 = new TicketBookingThread(bookingShow,mahesh,15);
        ...
        // After execution t3 will carry MAHESH ticket and t4 will carry SAURABH ticket
        Ticket maheshNewTicket = t3.getTicket();
        Ticket saurabhNewTicket = t4.getTicket();

        System.out.println(maheshNewTicket);
        ...
        then ticket is allocated to Mahesh,
